...
<template>
  <section class="px-5 pt-5 mt-4 lg:mt-0 space-y-6 basis-[260px] bg-white dark:bg-[#26272E]">
    ...
    <div class="px-4 py-5 border rounded-lg border-[#5d606e] space-y-8">
      <div v-for="item in [1, 2]" class="space-y-4">
        ...
        <div class="flex items-center text-sm" v-for="singleTrending in [1, 2, 3, 4]">
          <div
          ...
          <div class="ml-4">
            <div class="font-semibold text-white">Binance</div>
